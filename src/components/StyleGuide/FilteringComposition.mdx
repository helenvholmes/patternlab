...
import imageFilteringTextSearchField from "../../../static/filteringTextSearchField.png";
import imageFilteringFilterBar from "../../../static/filteringFilterBar.png";
import imageFilteringActiveFiltersList from "../../../static/filteringActiveFiltersList.png";
import imageFilteringTotalResultsHeading from "../../../static/filteringTotalResultsHeading.png";
import imageFilteringSortingMenu from "../../../static/filteringSortingMenu.png";
import imageFilteringPaginationMenu from "../../../static/filteringPaginationMenu.png";
...
- Text search field ([SearchBar](./?path=/docs/components-form-elements-searchbar--docs) or [TextInput](./?path=/docs/components-form-elements-textinput--docs) component)
- Filter bar ([FilterBarInline](./?path=/docs/components-form-elements-filterbarinline--docs) and [FilterBarPopup](./?path=/docs/components-form-elements-filterbarpopup--docs) components)
- Active filters list ([TagSet](./?path=/docs/components-content-display-tagset--docs) component)
- Sorting menu ([Menu](./?path=/docs/components-navigation-menu--docs) component)
- Total results heading ([Heading](./?path=/docs/components-typography-styles-heading--docs) component)
- Results list
- Pagination menu ([Pagination](./?path=/docs/components-navigation-pagination--docs) component)

## Text search field

<Image
  alt="Text search field example"
...
<Image
  alt="Active filters list example"
  borderRadius=".5rem"
...
<Image
  alt="Total results heading example"
  borderRadius=".5rem"
