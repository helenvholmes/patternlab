...
When JS is disabled, it is generally in desktop browsers and rarely in mobile
browsers. Still, in order to support a sensible default for the mobile filter
component, the popup should work without javascript.
