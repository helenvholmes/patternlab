...
The `Chakra Syntax` and `Semantic Syntax` examples below utilize the boolean
values to update text values based on the viewport size. Change the size of your
browser window and watch the text adjust as the width of the window decreases
and increases.
